...
class CV2VideoReader(VideoReaderInterface):

    def get_number_of_frames(self) -> int:
        return int(self.total_frames)

    def __init__(self, name,video_path, fps, buffer_size=64):
        super().__init__(name, video_path,fps)
    ...
    def start(self):
        ...
        self.stream.set(cv2.CAP_PROP_POS_FRAMES, self.current_index)
