...
class AlignmentDialog(QDialog):
    ...
    def __init__(self, parent, config:MuSeqPoseConfig, session_manager: SessionFileManager):
        ...
        file = QFile('Resources/AlignmentDialog.ui')
    ...
    def change_frame(self,frame_number):
        ...
        for i,view in enumerate(self.views):
            self.widgets[i].draw_frame(self.session_manager.session_video_readers[view].random_access_image(self.frame_number))